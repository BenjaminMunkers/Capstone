...
matplot(t(yhat_matrix), type = 'l', xlab = 'Percent of Acres Reported', ylab = 'Yield per Acre')
...
lines(q_upper, col = 'black', lty = 1, lwd = 5)
lines(q_lower, col = 'black', lty = 1, lwd = 5)

# Plot Interquartile range
iqr = q_upper - q_lower
matplot(percent_reported * 100, iqr, type = 'l', ylab = 'IQR', xlab = 'Percent of Acres Reported')
